...
run_and_get_time_seq "./tema1 tests/julia1.in julia1_sec.pgm tests/mandelbrot1.in mandelbrot1_sec.pgm"
run_and_get_time_seq "./tema1 tests/julia2.in julia2_sec.pgm tests/mandelbrot2.in mandelbrot2_sec.pgm"
run_and_get_time_seq "./tema1 tests/julia3.in julia3_sec.pgm tests/mandelbrot3.in mandelbrot3_sec.pgm"
run_and_get_time_seq "./tema1 tests/julia4.in julia4_sec.pgm tests/mandelbrot4.in mandelbrot4_sec.pgm"
echo "OK"
echo ""
